...
public abstract class NumberFormat extends Format
{
  ...
  /**
   * Field constant used to construct a FieldPosition object. Signifies that the
   * position of the integer part of a formatted number should be returned.
   * 
  ...
  /**
   * Field constant used to construct a FieldPosition object. Signifies that the
   * position of the fraction part of a formatted number should be returned.
   * 
   * @see java.text.FieldPosition
   */
   ...
   * {@link java.lang.Number#longValue()} for all integral type values that can
   * be converted to <code>long</code> without loss of information, including
   * <code>BigInteger</code> values with a
   * {@link java.math.BigInteger#bitLength() bit length} of less than 64, and
   * {@link java.lang.Number#doubleValue()} for all other types. It then calls
   * {@link #format(long,java.lang.StringBuffer,java.text.FieldPosition)} or
   * {@link #format(double,java.lang.StringBuffer,java.text.FieldPosition)}.
   ...
   * @param toAppendTo
   *          the <code>StringBuffer</code> to which the formatted text is to be
   *          appended
   * @param pos
   *          On input: an alignment field, if desired. On output: the offsets
   *          of the alignment field.
   * @return the value passed in as <code>toAppendTo</code>
   * @exception IllegalArgumentException
   *              if <code>number</code> is null or not an instance of
   *              <code>Number</code>.
   ...
   * number is returned. The updated <code>pos</code> can be used to indicate
   * the starting point for the next call to this method. If an error occurs,
   * then the index of <code>pos</code> is not changed, the error index of
   ...
   * numbers "1 2/3", will stop after the 1). Does not throw an exception; if no
   * object can be parsed, index is unchanged!
   * 
   ...
   * "1234." would be parsed as the integer value 1234 and parsing would stop at
   * the "." character. Of course, the exact format accepted by the parse
   ...
   * English locale, with grouping on, the number 1234567 might be formatted as
   * "1,234,567". The grouping separator as well as the size of each group is
   * locale dependant and is determined by sub-classes of NumberFormat.
   * 
   * @see #setGroupingUsed
   */
   ...
   * minimumIntegerDigits, then minimumIntegerDigits will also be set to the new
   * value.
   * 
   * @param newValue
   *          the maximum number of integer digits to be shown; if less than
   *          zero, then zero is used. The concrete subclass may enforce an
   *          upper limit to this value appropriate to the numeric type being
   *          formatted.
   ...
   * maximumIntegerDigits, then maximumIntegerDigits will also be set to the new
   * value
   * 
   * @param newValue
   ...
   * number. maximumFractionDigits must be >= minimumFractionDigits. If the new
   * value for maximumFractionDigits is less than the current value of
   ...
   * number. minimumFractionDigits must be <= maximumFractionDigits. If the new
   * value for minimumFractionDigits exceeds the current value of
  ...
  /**
   * Gets the currency used by this number format when formatting currency
   * values. The initial value is derived in a locale dependent way. The
   * returned value may be null if no valid currency could be determined and no
   * currency has been set using {@link #setCurrency(java.util.Currency)
   * setCurrency}.
   * <p>
   ...
   *              if the number format class doesn't implement currency
   *              formatting
   * @since 1.4
   */
  ...
  /**
   * Gets the {@link java.math.RoundingMode} used in this NumberFormat. The
   * default implementation of this method in NumberFormat always throws
   * {@link java.lang.UnsupportedOperationException}. Subclasses which handle
   * different rounding modes should override this method.
   * 
   * @exception UnsupportedOperationException
  ...
  /**
   * Sets the {@link java.math.RoundingMode} used in this NumberFormat. The
   * default implementation of this method in NumberFormat always throws
   * {@link java.lang.UnsupportedOperationException}. Subclasses which handle
   * different rounding modes should override this method.
   * 
   ...
   * the stream was written by JDK 1.1, set the <code>int</code> fields such as
   * <code>maximumIntegerDigits</code> to be equal to the <code>byte</code>
   * fields such as <code>maxIntegerDigits</code>, since the <code>int</code>
   * fields were not present in JDK 1.1. Finally, set serialVersionOnStream back
   * to the maximum allowed value so that default serialization will work
   * properly if this object is streamed out again.
   * 
   * <p>
   * If <code>minimumIntegerDigits</code> is greater than
   * <code>maximumIntegerDigits</code> or <code>minimumFractionDigits</code> is
   * greater than <code>maximumFractionDigits</code>, then the stream data is
   * invalid and this method throws an <code>InvalidObjectException</code>. In
   * addition, if any of these values is negative, then this method throws an
   ...
   * <code>byte</code> fields such as <code>maxIntegerDigits</code> to be equal
   * to the <code>int</code> fields such as <code>maximumIntegerDigits</code>
   * (or to <code>Byte.MAX_VALUE</code>, whichever is smaller), for
   * compatibility with the JDK 1.1 version of the stream format.
   * 
   * @since 1.2
   */
  ...
  /**
   * True if the grouping (i.e. thousands) separator is used when formatting and
   * parsing numbers.
   * 
   * @serial
   * @see #isGroupingUsed
   ...
   * <code>maximumIntegerDigits</code> or <code>Byte.MAX_VALUE</code>, whichever
   * is smaller. When reading from a stream, this field is used only if
   ...
   * <code>minimumIntegerDigits</code> or <code>Byte.MAX_VALUE</code>, whichever
   * is smaller. When reading from a stream, this field is used only if
   * <code>serialVersionOnStream</code> is less than 1.
   * 
   * @serial
